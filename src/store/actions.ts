...
import type { Post, PostWithUser } from "@/src/types"
...
export interface FetchPostDetailRequestAction extends Action<typeof FETCH_POST_DETAIL_REQUEST> {
  payload: number
}

export interface FetchPostDetailSuccessAction extends Action<typeof FETCH_POST_DETAIL_SUCCESS> {
  payload: PostWithUser
}

export interface FetchPostDetailFailureAction extends Action<typeof FETCH_POST_DETAIL_FAILURE> {
  payload: string
}

export interface ClearCurrentPostAction extends Action<typeof CLEAR_CURRENT_POST> {}
